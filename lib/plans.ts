...
export const PLAN_GENERATIONS: Record<string, PlanGenerationExample[]> = {
  free: [
    { label: 'Nano Banana 2', count: '6 imgs' },
    { label: 'Motion Control', count: '4 clips' },
    { label: 'Veo 3.1 Fast', count: 'bloqueado', blocked: true },
    { label: 'Veo 3.1 Quality', count: 'bloqueado', blocked: true },
  ],
  starter: [
    { label: 'Nano Banana 2', count: '80 imgs' },
  ...
  creator: [
    { label: 'Nano Banana 2', count: '240 imgs' },
  ...
  pro: [
    { label: 'Nano Banana 2', count: '600 imgs' },
  ...
  studio: [
    { label: 'Nano Banana 2', count: '1.600 imgs' },
