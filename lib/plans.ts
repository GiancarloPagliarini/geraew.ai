...
export const PLAN_GENERATION_ENTRIES: Record<string, PlanGenerationEntry[]> = {
  ...
  starter: [
    ...
    { label: 'Veo 3.1 Fast', countNumber: 4, unit: 'video' },
    { label: 'Veo 3.1 Quality', countNumber: 2, unit: 'video' },
  ...
  basic: [
    ...
    { label: 'Veo 3.1 Fast', countNumber: 7, unit: 'video' },
    { label: 'Veo 3.1 Quality', countNumber: 3, unit: 'video' },
  ...
  pro: [
    ...
    { label: 'Veo 3.1 Fast', countNumber: 33, unit: 'video' },
    { label: 'Veo 3.1 Quality', countNumber: 15, unit: 'video' },
  ...
  advanced: [
    ...
    { label: 'Veo 3.1 Fast', countNumber: 55, unit: 'video' },
    { label: 'Veo 3.1 Quality', countNumber: 25, unit: 'video' },
  ...
  studio: [
    ...
    { label: 'Veo 3.1 Fast', countNumber: 88, unit: 'video' },
    { label: 'Veo 3.1 Quality', countNumber: 40, unit: 'video' },
...
export const PLAN_GENERATIONS: Record<string, PlanGenerationExample[]> = {
  ...
  starter: [
    ...
    { label: 'Veo 3.1 Fast', count: '4 Vídeos' },
  ...
  basic: [
    ...
    { label: 'Veo 3.1 Fast', count: '7 Vídeos' },
    { label: 'Veo 3.1 Quality', count: '3 Vídeos' },
  ...
  pro: [
    ...
    { label: 'Veo 3.1 Fast', count: '33 Vídeos' },
    { label: 'Veo 3.1 Quality', count: '15 Vídeos' },
  ...
  advanced: [
    ...
    { label: 'Veo 3.1 Fast', count: '55 Vídeos' },
    { label: 'Veo 3.1 Quality', count: '25 Vídeos' },
  ...
  studio: [
    ...
    { label: 'Veo 3.1 Fast', count: '88 Vídeos' },
    { label: 'Veo 3.1 Quality', count: '40 Vídeos' },
