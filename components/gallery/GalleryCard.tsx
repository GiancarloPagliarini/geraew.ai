...
import { AudioLines, Heart, ImageOff } from 'lucide-react';
...
export const GALLERY_IMAGE_DRAG_TYPE = 'application/x-geraew-image-url';
    ...
    >
      ...
      {onToggleFavorite && (
        <button
          ...
          className={cn(
            'absolute right-2.5 top-2.5 z-10 flex size-8 items-center justify-center rounded-full bg-[rgba(13,16,17,0.65)] backdrop-blur-md transition-all duration-200 ease-app hover:bg-[rgba(13,16,17,0.85)]',
            item.isFavorited
