...
import { Pin, Plus, SquarePlay, X } from 'lucide-react';
...
import { VideoConfigPanel, type VideoPanelSeed } from '@/components/video/VideoConfigPanel';
    ...
    (async () => {
      try {
        ...
        [...pendingPage.data, ...processingPage.data]
          .filter((gen) => kindOf(gen.type) === 'video')
