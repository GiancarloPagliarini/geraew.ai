...
export function SupportButton() {
  ...
  const message = encodeURIComponent('Olá! Preciso de ajuda com a Geraew.');
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 hidden sm:block transition-transform hover:scale-110">
      <button
        ...
        aria-label="Fechar"
        className="absolute -top-1 -right-1 z-10 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-black/70 text-white/80 hover:bg-black hover:text-white transition-colors"
      >
      ...
      <a
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/40 hover:bg-[#1ebe5a] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 focus:ring-offset-[#1a2123]"
      >
