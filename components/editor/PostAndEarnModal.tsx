...
import { Gift, Sparkles, X, Instagram, Clock } from 'lucide-react';
      ...
      <div className="relative mx-4 w-full max-w-sm rounded-2xl border border-[#f3f0ed]/8 bg-[#1a2123] p-6 shadow-2xl">
        ...
        <div className="mt-5 flex flex-col gap-2">
          {[
            ...
            { label: 'Marque @geraewai', network: '@geraewai' },
            ...
            >
              <div className="flex items-center gap-2.5">
                <Instagram className="h-3.5 w-3.5 text-[#f3f0ed]/30" />
        ...
        <button
          onClick={onClose}
          className="mt-5 w-full rounded-xl bg-[#a2dd00] py-2.5 text-sm font-bold text-[#1a2123] transition-all hover:brightness-110 active:scale-95"
        >
          Entendido
        </button>
      </div>
