...
export function BuyCreditsModal({ onClose }: BuyCreditsModalProps) {
  ...
  return (
    ...
    >
      <div className="relative mx-4 flex max-h-[90vh] w-full max-w-5xl flex-col gap-4 overflow-y-auto sidebar-scroll rounded-2xl border border-[#f3f0ed]/8 bg-[#1a2123] p-4 shadow-2xl sm:gap-6 sm:overflow-visible sm:p-6">
